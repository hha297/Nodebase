...
export function NodeSelector({ open, onOpenChange, children }: NodeSelectorProps) {
        ...
        const handleNodeSelect = useCallback(
                (selectedNode: NodeTypeOption) => {
                        // Check if trying to add a manual trigger and if there is already one
                ...
                <Sheet open={open} onOpenChange={onOpenChange}>
                        ...
                        <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
                                <SheetHeader>
                                        ...
                                        <SheetDescription>
                                                Select the type of trigger you want to use to start this workflow.
                                        </SheetDescription>
                                </SheetHeader>
                                <div>
                                        {triggerNodes.map((nodeType) => {
                                                ...
                                                return (
                                                        <div
                                                                key={nodeType.type}
                                                                className="w-full justify-start h-auto p-4 rounded-none cursor-pointer border-l-2 border-transparent hover:border-l-primary"
